...
4. `MODDING_FROM_ZERO.md`
   - Slay the Spire 2 모딩과 현재 저장소의 핵심 개념을 처음부터 설명합니다.
5. `GAMEPLAY_RUNTIME_FLOW.md`
