...
> Status: Tutorial
> Source of truth: No
> Use this for onboarding and repo orientation, not for current blocker or contract decisions.
...
3. `docs/snapshots/runtime/GAMEPLAY_RUNTIME_FLOW.md`
4. `docs/reference/runtime/LOAD_CHAIN.md`
