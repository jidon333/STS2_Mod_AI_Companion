...
> Status: Tutorial
> Source of truth: No
> Use this for onboarding and orientation, not for current blocker or contract decisions.
...
## 1-1. 이 저장소에서 가장 먼저 볼 것

- [docs/README.md](../README.md)
- [docs/current/PROJECT_STATUS.md](../current/PROJECT_STATUS.md)
- [docs/current/AI_HANDOFF_PROMPT_KO.md](../current/AI_HANDOFF_PROMPT_KO.md)

이 세 문서를 먼저 보면 현재 저장소가 무엇을 하고 있는지와 지금 어디까지 와 있는지 빠르게 잡을 수 있습니다.
