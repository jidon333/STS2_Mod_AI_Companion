...
> Status: Archive
> Source of truth: No
> Superseded by [docs/README.md](../../README.md) and [PROJECT_STATUS.md](../../current/PROJECT_STATUS.md).
...
- [AI_HANDOFF_PROMPT_KO.md](../../current/AI_HANDOFF_PROMPT_KO.md)
...
4. [CURRENT_MILESTONE_CHECKLIST.md](./CURRENT_MILESTONE_CHECKLIST.md)
5. [RUNNER_SUPERVISOR_AGENT_ARCHITECTURE.md](../../contracts/RUNNER_SUPERVISOR_AGENT_ARCHITECTURE.md)
6. [STARTUP_DEPLOY_CONTROL_LAYER.md](../../contracts/STARTUP_DEPLOY_CONTROL_LAYER.md)
7. [HARNESS_LAYER_ARCHITECTURE.md](../../reference/harness/HARNESS_LAYER_ARCHITECTURE.md)
8. [STS2_HARNESS_REVIEW.md](../../snapshots/harness/STS2_HARNESS_REVIEW.md)
9. [HARNESS_MODE.md](../../reference/harness/HARNESS_MODE.md)
10. [DECOMPILED_SOURCE_FIRST_OBSERVER_STRATEGY.md](../../reference/harness/DECOMPILED_SOURCE_FIRST_OBSERVER_STRATEGY.md)
11. [WORKLOG.md](../history/WORKLOG.md)
...
## Historical Rule At Supersede Time

- `Phase 1 완료`, `당시 active milestone 완료`, `세션 1회 done`은 서로 다른 개념이다.
- startup/trust, gameplay, advisor product surface는 acceptance를 섞지 않는다.
- 당시 active milestone은 `M4. Trusted Attempt 확보`였다.
- 당시 current blocker는 더 이상 `loader debugging`이나 `event/map overlay`가 아니라 `authoritative attempt / session accounting contract`였다.
