...
즉 지금 남은 핵심은 noncombat mixed-state나 combat EndTurn barrier blocker가 아니라, strict lifecycle coverage와 일부 partial evidence row입니다.
...
이제 남은 건 strict lifecycle coverage와 일부 partial evidence row를
