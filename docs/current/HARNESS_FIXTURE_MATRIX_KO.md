...
| `REWARD-02` | `HandleRewards` | reward card / colorless | partial | `Program.SelfTests.NonCombatDecisionContracts.RewardContracts.cs` colorless and reward choice assertions, fresh live root [verify-reward-claim-20260401-live1](/mnt/c/Users/jidon/source/repos/STS2_Mod_AI_Companion/artifacts/gui-smoke/verify-reward-claim-20260401-live1) attempt `0001`, smoke root [slippery-bridge-overcome-20260403-live2](/mnt/c/Users/jidon/source/repos/STS2_Mod_AI_Companion/artifacts/gui-smoke/slippery-bridge-overcome-20260403-live2) step `260` | generic bare `card` residue는 reward authority가 아니다. old `reward card choice` same-action-stall root는 historical evidence로 남아 있지만, latest smoke에서는 same-action terminal이 아니라 child-screen visibility/smoothness evidence가 아직 얇은 partial로 본다 |
