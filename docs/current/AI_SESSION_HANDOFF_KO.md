...
6. final lane은 final actionable surface로만 뒷받침한다. metadata-only lane promotion은 금지하고, same-family reconciliation surface가 없으면 plateau가 아니라 explicit contract mismatch로 드러낸다.
