...
> Status: Snapshot
> Source of truth: No
> This is a point-in-time advisor architecture note. Current truth lives in [ARCHITECTURE.md](../../ARCHITECTURE.md) and [PROJECT_STATUS.md](../../current/PROJECT_STATUS.md).
