...
{
	[CompilerGenerated]
	private sealed class _003CGetAllSaveFiles_003Ed__20 : IEnumerable<string>, IEnumerable, IEnumerator<string>, IEnumerator, IDisposable
	{
		...
		public string _003C_003E3__accountBasePath;
		...
		[DebuggerHidden]
		public _003CGetAllSaveFiles_003Ed__20(int _003C_003E1__state)
		{
		...
		private bool MoveNext()
		{
			try
			{
				...
				else
				{
					...
					_003C_003E7__wrap1 = Directory.EnumerateFiles(accountBasePath, "*", SearchOption.AllDirectories).GetEnumerator();
					_003C_003E1__state = -3;
				}
		...
		{
			_003CGetAllSaveFiles_003Ed__20 _003CGetAllSaveFiles_003Ed__;
			if (_003C_003E1__state == -2 && _003C_003El__initialThreadId == System.Environment.CurrentManagedThreadId)
			{
				_003C_003E1__state = 0;
				_003CGetAllSaveFiles_003Ed__ = this;
			}
			else
			{
				_003CGetAllSaveFiles_003Ed__ = new _003CGetAllSaveFiles_003Ed__20(0);
			}
			_003CGetAllSaveFiles_003Ed__.accountBasePath = _003C_003E3__accountBasePath;
			return _003CGetAllSaveFiles_003Ed__;
		}
	...
	public static async Task GrabLogs(string bugReportPath)
	{
		...
		FileStream fileStream = new FileStream(bugReportPath, FileMode.CreateNew);
		try
		{
			ZipFiles(fileStream, image.SavePngToBuffer());
		}
		finally
		{
			if (fileStream != null)
	...
	[IteratorStateMachine(typeof(_003CGetAllSaveFiles_003Ed__20))]
	private static IEnumerable<string> GetAllSaveFiles(string accountBasePath)
	{
		//yield-return decompiler failed: Unexpected instruction in Iterator.Dispose()
		return new _003CGetAllSaveFiles_003Ed__20(-2)
		{
			_003C_003E3__accountBasePath = accountBasePath
		};
	}
