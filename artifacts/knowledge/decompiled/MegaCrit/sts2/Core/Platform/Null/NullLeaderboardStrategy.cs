...
public class NullLeaderboardStrategy : ILeaderboardStrategy
{
	...
	{
		NullLeaderboardHandle handle2 = handle;
		...
		if (handle2 != null)
		{
			handle2.leaderboard = _leaderboards.First((NullLeaderboard l) => l.name == handle2.leaderboard.name);
		}
	}
}
