...
public class UsePotionAction : GameAction
{
	...
	{
		NetUsePotionAction netUsePotionAction = default(NetUsePotionAction);
		netUsePotionAction.potionIndex = PotionIndex;
		netUsePotionAction.targetId = TargetId;
		netUsePotionAction.targetPlayerId = TargetPlayerId;
		netUsePotionAction.enqueuedInCombat = WasEnqueuedInCombat;
		return netUsePotionAction;
	}
