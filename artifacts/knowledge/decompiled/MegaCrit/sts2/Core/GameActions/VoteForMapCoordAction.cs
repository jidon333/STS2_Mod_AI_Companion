...
public class VoteForMapCoordAction : GameAction
{
	...
	{
		NetVoteForMapCoordAction netVoteForMapCoordAction = default(NetVoteForMapCoordAction);
		netVoteForMapCoordAction.source = _source;
		netVoteForMapCoordAction.destination = _destination;
