...
public class ActionQueueSet
{
	...
	public void ResumeActionWithoutSynchronizing(uint id)
	{
		...
		else
		{
			...
			ActionWaitingForResumption actionWaitingForResumption = default(ActionWaitingForResumption);
			actionWaitingForResumption.oldId = id;
			actionWaitingForResumption.newId = andIncrementActionId;
			ActionWaitingForResumption item = actionWaitingForResumption;
