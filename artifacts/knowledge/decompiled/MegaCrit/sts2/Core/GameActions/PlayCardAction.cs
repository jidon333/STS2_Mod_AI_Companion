...
public sealed class PlayCardAction : GameAction
{
	...
	protected override async Task ExecuteAction()
	{
		...
		resourceInfo.EnergySpent = item;
		resourceInfo.EnergyValue = item;
		resourceInfo.StarsSpent = item2;
		resourceInfo.StarValue = item2;
	...
	{
		NetPlayCardAction netPlayCardAction = default(NetPlayCardAction);
		netPlayCardAction.card = NetCombatCard;
		netPlayCardAction.modelId = CardModelId;
		netPlayCardAction.targetId = TargetId;
		NetPlayCardAction netPlayCardAction2 = netPlayCardAction;
		return netPlayCardAction2;
	}
