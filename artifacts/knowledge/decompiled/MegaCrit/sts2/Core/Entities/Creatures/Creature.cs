...
public class Creature
{
	...
	{
		ModelId id2 = id;
		return _powers.Any((PowerModel p) => p.Id == id2);
	}
	...
	{
		ModelId id2 = id;
		return _powers.FirstOrDefault((PowerModel p) => p.Id == id2);
	}
