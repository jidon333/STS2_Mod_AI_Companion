...
public class ENetPacket
{
	...
	public ENetHandshakeRequest AsHandshakeRequest()
	{
		...
		ENetHandshakeRequest result = default(ENetHandshakeRequest);
		result.netId = netId;
		return result;
	}
	...
	public ENetHandshakeResponse AsHandshakeResponse()
	{
		...
		ENetHandshakeResponse result = default(ENetHandshakeResponse);
		result.netId = netId;
	...
	public ENetDisconnection AsDisconnection()
	{
		...
		ENetDisconnection result = default(ENetDisconnection);
