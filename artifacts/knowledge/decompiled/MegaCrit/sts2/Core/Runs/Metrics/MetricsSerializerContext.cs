...
internal class MetricsSerializerContext : JsonSerializerContext, IJsonTypeInfoResolver
{
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<AchievementMetric> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => AchievementMetricPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<ActWinMetric> jsonTypeInfo))
		{
			JsonObjectInfoValues<ActWinMetric> objectInfo = new JsonObjectInfoValues<ActWinMetric>
			{
				ObjectCreator = () => default(ActWinMetric),
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => ActWinMetricPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<AncientMetric> jsonTypeInfo))
		{
			JsonObjectInfoValues<AncientMetric> objectInfo = new JsonObjectInfoValues<AncientMetric>
			{
				ObjectCreator = () => default(AncientMetric),
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => AncientMetricPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<CardChoiceMetric> jsonTypeInfo))
		{
			JsonObjectInfoValues<CardChoiceMetric> objectInfo = new JsonObjectInfoValues<CardChoiceMetric>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => CardChoiceMetricPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<EncounterMetric> jsonTypeInfo))
		{
			JsonObjectInfoValues<EncounterMetric> objectInfo = new JsonObjectInfoValues<EncounterMetric>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => EncounterMetricPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<EventChoiceMetric> jsonTypeInfo))
		{
			JsonObjectInfoValues<EventChoiceMetric> objectInfo = new JsonObjectInfoValues<EventChoiceMetric>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => EventChoiceMetricPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<RunMetrics> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => RunMetricsPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SettingsDataMetric> jsonTypeInfo))
		{
			JsonObjectInfoValues<SettingsDataMetric> jsonObjectInfoValues = new JsonObjectInfoValues<SettingsDataMetric>();
			jsonObjectInfoValues.ObjectCreator = null;
			jsonObjectInfoValues.ObjectWithParameterizedConstructorCreator = delegate(object[] args)
			{
				SettingsDataMetric result = default(SettingsDataMetric);
				result.BuildId = (string)args[0];
				result.FastModeType = (FastModeType)args[1];
				return result;
			};
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => SettingsDataMetricPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<EpochMetric> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => EpochMetricPropInit(options2);
