...
public sealed class DecimillipedeElite : EncounterModel
{
	...
	protected override IReadOnlyList<(MonsterModel, string?)> GenerateMonsters()
	{
		...
		int num2 = (decimillipedeSegment.StarterMoveIdx = base.Rng.NextInt(3));
		decimillipedeSegment2.StarterMoveIdx = (num2 + 1) % 3;
		decimillipedeSegment3.StarterMoveIdx = (num2 + 2) % 3;
