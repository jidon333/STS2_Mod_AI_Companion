...
public sealed class Voltaic : CardModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new global::_003C_003Ez__ReadOnlyArray<DynamicVar>(new DynamicVar[3]
	{
		...
		new CalculatedVar("CalculatedChannels").WithMultiplier(delegate(CardModel card, Creature? _)
		{
			CardModel card2 = card;
			return CombatManager.Instance.History.Entries.OfType<OrbChanneledEntry>().Count((OrbChanneledEntry e) => e.Actor.Player == card2.Owner && e.Orb is LightningOrb);
		})
	});
