...
public class GodotFileIo : ISaveStore
{
	...
	public async Task<string?> ReadFileAsync(string path)
	{
		...
		FileAccessStream stream = new FileAccessStream(path, Godot.FileAccess.ModeFlags.Read);
		string @string;
		try
		{
	...
	public async Task WriteFileAsync(string path, byte[] bytes)
	{
		...
		FileAccessStream stream = new FileAccessStream(tempPath, Godot.FileAccess.ModeFlags.Write);
		try
		{
