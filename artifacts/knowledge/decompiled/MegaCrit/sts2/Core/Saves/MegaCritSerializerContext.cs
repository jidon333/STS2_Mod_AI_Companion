...
internal class MegaCritSerializerContext : JsonSerializerContext, IJsonTypeInfoResolver
{
	...
	private JsonTypeInfo<Vector2> Create_Vector2(JsonSerializerOptions options)
	{
		...
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<Vector2> jsonTypeInfo))
		{
			JsonObjectInfoValues<Vector2> objectInfo = new JsonObjectInfoValues<Vector2>
			{
				ObjectCreator = () => default(Vector2),
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => Vector2PropInit(options2),
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<Vector2I> jsonTypeInfo))
		{
			JsonObjectInfoValues<Vector2I> objectInfo = new JsonObjectInfoValues<Vector2I>
			{
				ObjectCreator = () => default(Vector2I),
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => Vector2IPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<LocString> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => LocStringPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<MapCoord> jsonTypeInfo))
		{
			JsonObjectInfoValues<MapCoord> objectInfo = new JsonObjectInfoValues<MapCoord>
			{
				ObjectCreator = () => default(MapCoord),
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => MapCoordPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<DisabledMod> jsonTypeInfo))
		{
			JsonObjectInfoValues<DisabledMod> objectInfo = new JsonObjectInfoValues<DisabledMod>
			{
				ObjectCreator = () => new DisabledMod(),
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => DisabledModPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<ModManifest> jsonTypeInfo))
		{
			JsonObjectInfoValues<ModManifest> objectInfo = new JsonObjectInfoValues<ModManifest>
			{
				ObjectCreator = () => new ModManifest(),
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => ModManifestPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<ModSettings> jsonTypeInfo))
		{
			JsonObjectInfoValues<ModSettings> objectInfo = new JsonObjectInfoValues<ModSettings>
			{
				ObjectCreator = () => new ModSettings(),
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => ModSettingsPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<ModelId> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => ModelIdPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<FeedbackData> jsonTypeInfo))
		{
			JsonObjectInfoValues<FeedbackData> objectInfo = new JsonObjectInfoValues<FeedbackData>
			{
				ObjectCreator = () => default(FeedbackData),
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => FeedbackDataPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<NullLeaderboard> jsonTypeInfo))
		{
			JsonObjectInfoValues<NullLeaderboard> objectInfo = new JsonObjectInfoValues<NullLeaderboard>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => NullLeaderboardPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<NullLeaderboardFile> jsonTypeInfo))
		{
			JsonObjectInfoValues<NullLeaderboardFile> objectInfo = new JsonObjectInfoValues<NullLeaderboardFile>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => NullLeaderboardFilePropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<NullLeaderboardFileEntry> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => NullLeaderboardFileEntryPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<NullMultiplayerName> jsonTypeInfo))
		{
			JsonObjectInfoValues<NullMultiplayerName> objectInfo = new JsonObjectInfoValues<NullMultiplayerName>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => NullMultiplayerNamePropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<AncientChoiceHistoryEntry> jsonTypeInfo))
		{
			JsonObjectInfoValues<AncientChoiceHistoryEntry> objectInfo = new JsonObjectInfoValues<AncientChoiceHistoryEntry>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => AncientChoiceHistoryEntryPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<CardChoiceHistoryEntry> jsonTypeInfo))
		{
			JsonObjectInfoValues<CardChoiceHistoryEntry> objectInfo = new JsonObjectInfoValues<CardChoiceHistoryEntry>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => CardChoiceHistoryEntryPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<CardEnchantmentHistoryEntry> jsonTypeInfo))
		{
			JsonObjectInfoValues<CardEnchantmentHistoryEntry> objectInfo = new JsonObjectInfoValues<CardEnchantmentHistoryEntry>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => CardEnchantmentHistoryEntryPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<CardTransformationHistoryEntry> jsonTypeInfo))
		{
			JsonObjectInfoValues<CardTransformationHistoryEntry> objectInfo = new JsonObjectInfoValues<CardTransformationHistoryEntry>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => CardTransformationHistoryEntryPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<EventOptionHistoryEntry> jsonTypeInfo))
		{
			JsonObjectInfoValues<EventOptionHistoryEntry> objectInfo = new JsonObjectInfoValues<EventOptionHistoryEntry>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => EventOptionHistoryEntryPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<MapPointHistoryEntry> jsonTypeInfo))
		{
			JsonObjectInfoValues<MapPointHistoryEntry> objectInfo = new JsonObjectInfoValues<MapPointHistoryEntry>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => MapPointHistoryEntryPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<MapPointRoomHistoryEntry> jsonTypeInfo))
		{
			JsonObjectInfoValues<MapPointRoomHistoryEntry> objectInfo = new JsonObjectInfoValues<MapPointRoomHistoryEntry>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => MapPointRoomHistoryEntryPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<ModelChoiceHistoryEntry> jsonTypeInfo))
		{
			JsonObjectInfoValues<ModelChoiceHistoryEntry> objectInfo = new JsonObjectInfoValues<ModelChoiceHistoryEntry>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => ModelChoiceHistoryEntryPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<PlayerMapPointHistoryEntry> jsonTypeInfo))
		{
			JsonObjectInfoValues<PlayerMapPointHistoryEntry> objectInfo = new JsonObjectInfoValues<PlayerMapPointHistoryEntry>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => PlayerMapPointHistoryEntryPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<RunHistory> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => RunHistoryPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<RunHistoryPlayer> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => RunHistoryPlayerPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<AncientCharacterStats> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => AncientCharacterStatsPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<AncientStats> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => AncientStatsPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<CardStats> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => CardStatsPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<CharacterStats> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => CharacterStatsPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<EncounterStats> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => EncounterStatsPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<EnemyStats> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => EnemyStatsPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<FightStats> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => FightStatsPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableMapDrawingLine> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableMapDrawingLine> objectInfo = new JsonObjectInfoValues<SerializableMapDrawingLine>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableMapDrawingLinePropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableMapDrawings> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableMapDrawings> objectInfo = new JsonObjectInfoValues<SerializableMapDrawings>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableMapDrawingsPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializablePlayerMapDrawings> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializablePlayerMapDrawings> objectInfo = new JsonObjectInfoValues<SerializablePlayerMapDrawings>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializablePlayerMapDrawingsPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<MigratingData> jsonTypeInfo))
		{
			JsonObjectInfoValues<MigratingData> objectInfo = new JsonObjectInfoValues<MigratingData>
			{
				ObjectCreator = null,
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => MigratingDataPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<PrefsSave> jsonTypeInfo))
		{
			JsonObjectInfoValues<PrefsSave> objectInfo = new JsonObjectInfoValues<PrefsSave>
			{
				ObjectCreator = () => new PrefsSave(),
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => PrefsSavePropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<ProfileSave> jsonTypeInfo))
		{
			JsonObjectInfoValues<ProfileSave> objectInfo = new JsonObjectInfoValues<ProfileSave>
			{
				ObjectCreator = () => new ProfileSave(),
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => ProfileSavePropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SavedProperties> jsonTypeInfo))
		{
			JsonObjectInfoValues<SavedProperties> objectInfo = new JsonObjectInfoValues<SavedProperties>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SavedPropertiesPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SavedProperties.SavedProperty<bool>> jsonTypeInfo))
		{
			JsonObjectInfoValues<SavedProperties.SavedProperty<bool>> objectInfo = new JsonObjectInfoValues<SavedProperties.SavedProperty<bool>>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SavedPropertyBooleanPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SavedProperties.SavedProperty<ModelId>> jsonTypeInfo))
		{
			JsonObjectInfoValues<SavedProperties.SavedProperty<ModelId>> objectInfo = new JsonObjectInfoValues<SavedProperties.SavedProperty<ModelId>>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SavedPropertyModelIdPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SavedProperties.SavedProperty<SerializableCard[]>> jsonTypeInfo))
		{
			JsonObjectInfoValues<SavedProperties.SavedProperty<SerializableCard[]>> objectInfo = new JsonObjectInfoValues<SavedProperties.SavedProperty<SerializableCard[]>>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SavedPropertySerializableCardArrayPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	private JsonTypeInfo<SavedProperties.SavedProperty<SerializableCard>> Create_SavedPropertySerializableCard(JsonSerializerOptions options)
	{
		...
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SavedProperties.SavedProperty<SerializableCard>> jsonTypeInfo))
		{
			JsonObjectInfoValues<SavedProperties.SavedProperty<SerializableCard>> objectInfo = new JsonObjectInfoValues<SavedProperties.SavedProperty<SerializableCard>>
			{
				ObjectCreator = () => default(SavedProperties.SavedProperty<SerializableCard>),
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SavedPropertySerializableCardPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
				ConstructorAttributeProviderFactory = () => typeof(SavedProperties.SavedProperty<SerializableCard>).GetConstructor(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, Array.Empty<Type>(), null),
				SerializeHandler = null
			};
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SavedProperties.SavedProperty<int[]>> jsonTypeInfo))
		{
			JsonObjectInfoValues<SavedProperties.SavedProperty<int[]>> objectInfo = new JsonObjectInfoValues<SavedProperties.SavedProperty<int[]>>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SavedPropertyInt32ArrayPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	private JsonTypeInfo<SavedProperties.SavedProperty<int>> Create_SavedPropertyInt32(JsonSerializerOptions options)
	{
		...
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SavedProperties.SavedProperty<int>> jsonTypeInfo))
		{
			JsonObjectInfoValues<SavedProperties.SavedProperty<int>> objectInfo = new JsonObjectInfoValues<SavedProperties.SavedProperty<int>>
			{
				ObjectCreator = () => default(SavedProperties.SavedProperty<int>),
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SavedPropertyInt32PropInit(options2),
				ConstructorParameterMetadataInitializer = null,
				ConstructorAttributeProviderFactory = () => typeof(SavedProperties.SavedProperty<int>).GetConstructor(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, Array.Empty<Type>(), null),
				SerializeHandler = null
			};
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SavedProperties.SavedProperty<string>> jsonTypeInfo))
		{
			JsonObjectInfoValues<SavedProperties.SavedProperty<string>> objectInfo = new JsonObjectInfoValues<SavedProperties.SavedProperty<string>>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SavedPropertyStringPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableActMap> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableActMap> objectInfo = new JsonObjectInfoValues<SerializableActMap>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableActMapPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableActModel> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableActModel> objectInfo = new JsonObjectInfoValues<SerializableActModel>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableActModelPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableCard> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableCard> objectInfo = new JsonObjectInfoValues<SerializableCard>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableCardPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableEnchantment> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableEnchantment> objectInfo = new JsonObjectInfoValues<SerializableEnchantment>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableEnchantmentPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableExtraRunFields> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableExtraRunFields> objectInfo = new JsonObjectInfoValues<SerializableExtraRunFields>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableExtraRunFieldsPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableMapPoint> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableMapPoint> objectInfo = new JsonObjectInfoValues<SerializableMapPoint>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableMapPointPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableModifier> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableModifier> objectInfo = new JsonObjectInfoValues<SerializableModifier>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableModifierPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializablePlayer> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializablePlayer> objectInfo = new JsonObjectInfoValues<SerializablePlayer>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializablePlayerPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializablePlayerOddsSet> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializablePlayerOddsSet> objectInfo = new JsonObjectInfoValues<SerializablePlayerOddsSet>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializablePlayerOddsSetPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializablePotion> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializablePotion> objectInfo = new JsonObjectInfoValues<SerializablePotion>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializablePotionPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableRelic> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableRelic> objectInfo = new JsonObjectInfoValues<SerializableRelic>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableRelicPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableRelicGrabBag> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableRelicGrabBag> objectInfo = new JsonObjectInfoValues<SerializableRelicGrabBag>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableRelicGrabBagPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableReward> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableReward> objectInfo = new JsonObjectInfoValues<SerializableReward>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableRewardPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableRoom> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableRoom> objectInfo = new JsonObjectInfoValues<SerializableRoom>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableRoomPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableRoomSet> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableRoomSet> objectInfo = new JsonObjectInfoValues<SerializableRoomSet>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableRoomSetPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableRunOddsSet> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableRunOddsSet> objectInfo = new JsonObjectInfoValues<SerializableRunOddsSet>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableRunOddsSetPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableRunRngSet> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableRunRngSet> objectInfo = new JsonObjectInfoValues<SerializableRunRngSet>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableRunRngSetPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableEpoch> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableEpochPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableExtraPlayerFields> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableExtraPlayerFields> objectInfo = new JsonObjectInfoValues<SerializableExtraPlayerFields>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableExtraPlayerFieldsPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializablePlayerRngSet> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializablePlayerRngSet> objectInfo = new JsonObjectInfoValues<SerializablePlayerRngSet>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializablePlayerRngSetPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableProgress> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableProgressPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableRun> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableRun> objectInfo = new JsonObjectInfoValues<SerializableRun>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableRunPropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableUnlockedAchievement> jsonTypeInfo))
		{
			...
			jsonObjectInfoValues.PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableUnlockedAchievementPropInit(options2);
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SettingsSave> jsonTypeInfo))
		{
			JsonObjectInfoValues<SettingsSave> objectInfo = new JsonObjectInfoValues<SettingsSave>
			{
				ObjectCreator = () => new SettingsSave(),
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SettingsSavePropInit(options2),
				ConstructorParameterMetadataInitializer = null,
	...
	{
		JsonSerializerOptions options2 = options;
		if (!TryGetTypeInfoForRuntimeCustomConverter(options2, out JsonTypeInfo<SerializableUnlockState> jsonTypeInfo))
		{
			JsonObjectInfoValues<SerializableUnlockState> objectInfo = new JsonObjectInfoValues<SerializableUnlockState>
			{
				...
				ObjectWithParameterizedConstructorCreator = null,
				PropertyMetadataInitializer = (JsonSerializerContext _) => SerializableUnlockStatePropInit(options2),
				ConstructorParameterMetadataInitializer = null,
