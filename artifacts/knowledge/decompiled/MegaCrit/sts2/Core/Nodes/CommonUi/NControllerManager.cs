...
public class NControllerManager : Node
{
	...
	private void CheckForControllerInput(InputEvent inputEvent)
	{
		...
		if (Controller.AllControllerInputs.Any((StringName i) => inputEvent2.IsActionPressed(i)))
		{
	...
	protected override bool GetGodotClassPropertyValue(in godot_string_name name, out godot_variant value)
	{
		...
		{
			ControllerMappingType from2 = ControllerMappingType;
	...
	protected override void SaveGodotObjectData(GodotSerializationInfo info)
	{
		...
		bool from = IsUsingController;
		info.AddProperty(isUsingController, Variant.From(in from));
