...
public class NRun : Control
{
	...
	protected override void SaveGodotObjectData(GodotSerializationInfo info)
	{
		...
		NGlobalUi from = GlobalUi;
		info.AddProperty(globalUi, Variant.From(in from));
		StringName runMusicController = PropertyName.RunMusicController;
		NRunMusicController from2 = RunMusicController;
		info.AddProperty(runMusicController, Variant.From(in from2));
