...
public class NEventLayout : Control
{
	...
	public void AddOptions(IEnumerable<EventOption> options)
	{
		if (_sharedEventLabel != null)
		{
			...
			sharedEventLabel.Visible = @event != null && @event.IsShared && !@event.IsFinished && _event.Owner.RunState.Players.Count > 1;
		}
	...
	protected override void SaveGodotObjectData(GodotSerializationInfo info)
	{
		...
		Control from = VfxContainer;
		info.AddProperty(vfxContainer, Variant.From(in from));
