...
public class NTimelineScreen : NSubmenu
{
	...
	[CompilerGenerated]
	private sealed class _003CGetAllEraTexturePaths_003Ed__40 : IEnumerable<string>, IEnumerable, IEnumerator<string>, IEnumerator, IDisposable
	{
		...
		[DebuggerHidden]
		public _003CGetAllEraTexturePaths_003Ed__40(int _003C_003E1__state)
		{
		...
		IEnumerator<string> IEnumerable<string>.GetEnumerator()
		{
			...
			return new _003CGetAllEraTexturePaths_003Ed__40(0);
		}
	...
	[IteratorStateMachine(typeof(_003CGetAllEraTexturePaths_003Ed__40))]
	private static IEnumerable<string> GetAllEraTexturePaths()
	{
		//yield-return decompiler failed: Unexpected instruction in Iterator.Dispose()
		return new _003CGetAllEraTexturePaths_003Ed__40(-2);
	}
	...
	protected override bool InvokeGodotClassMethod(in godot_string_name method, NativeVariantPtrArgs args, out godot_variant ret)
	{
		...
		{
			string from2 = GetEraTexturePath(VariantUtils.ConvertTo<EpochEra>(in args[0]));
			ret = VariantUtils.CreateFrom(in from2);
			return true;
		}
		if (method == MethodName.GetSlot && args.Count == 2)
		{
			NEpochSlot from3 = GetSlot(VariantUtils.ConvertTo<EpochEra>(in args[0]), VariantUtils.ConvertTo<int>(in args[1]));
		...
		{
			Control from6 = GetReminderVfxHolder();
	...
	protected override bool GetGodotClassPropertyValue(in godot_string_name name, out godot_variant value)
	{
		...
		{
			Control from = InitialFocusedControl;
