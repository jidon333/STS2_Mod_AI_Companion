...
- ID: `event-67c16c93195a`
- 그룹/풀 추정: 선택지 확인됨
- 플레이 중 참조 시점: 이벤트 본문과 선택지 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 부메랑 칼날, 분노, 불타는 혈액, 사전 타격
- 확인된 선택지:
  - 부메랑 칼날
  - 분노
  - 불타는 혈액
...
- ID: `event-82a2f419b87c`
- 그룹/풀 추정: 선택지 확인됨
- 플레이 중 참조 시점: 이벤트 본문과 선택지 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. Deck, Dismisser, Exclaim, Map
- 확인된 선택지:
  - Deck
  - Dismisser
  - Exclaim
...
- ID: `event-ded7594b20ca`
- 그룹/풀 추정: 선택지 확인됨
- 플레이 중 참조 시점: 이벤트 본문과 선택지 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. Dismisser, Exclaim, Question, 불타는 혈액
- 확인된 선택지:
  - Dismisser
  - Exclaim
  - Question
...
- ID: `event-62f5270d18c0`
- 그룹/풀 추정: 선택지 확인됨
- 플레이 중 참조 시점: 이벤트 본문과 선택지 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. NDeckTransformSelectScreen, 불타는 혈액, 새로운 잎, 수비
- 확인된 선택지:
...
- ID: `event-c066c45a51a3`
- 그룹/풀 추정: 선택지 확인됨
- 플레이 중 참조 시점: 이벤트 본문과 선택지 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 새로운 잎, 영양만점 굴, 은 도가니
- 확인된 선택지:
  - 새로운 잎
  - 영양만점 굴
  - 은 도가니
...
- ID: `event-bdb959ae1841`
- 그룹/풀 추정: 선택지 확인됨
- 플레이 중 참조 시점: 이벤트 본문과 선택지 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 묵묵히 나아간다, 휴식한다
- 확인된 선택지:
  - 묵묵히 나아간다
  - 휴식한다
- 관찰 로그 반영: 예
...
- ID: `event-f2935ce3d9f0`
- 그룹/풀 추정: 선택지 확인됨
- 플레이 중 참조 시점: 이벤트 본문과 선택지 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 골드를 거래한다, 나무를 끌어안는다
- 확인된 선택지:
  - 골드를 거래한다
  - 나무를 끌어안는다
- 관찰 로그 반영: 예
