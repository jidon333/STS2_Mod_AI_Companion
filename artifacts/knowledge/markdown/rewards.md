...
- ID: `reward-b71fa31d7ce7`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 7턴 종료, 불타는 혈액, 붉은 해골, 새로운 잎
- 확인된 선택지:
  - 7턴 종료
  - 불타는 혈액
  - 붉은 해골
...
- ID: `reward-31a5aa1c30b7`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 3턴 종료, 강타, 불타는 혈액, 붉은 해골
- 확인된 선택지:
  - 3턴 종료
  - 강타
  - 불타는 혈액
...
- ID: `reward-041fb087adc7`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. NCardRewardSelectionScreen, 거상, 넘기기, 약화 포션
- 확인된 선택지:
  - NCardRewardSelectionScreen
  - 거상
  - 넘기기
...
- ID: `reward-1dbf41541f5c`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 5턴 종료, 불타는 혈액, 새로운 잎, 진행
- 확인된 선택지:
  - 5턴 종료
  - 불타는 혈액
  - 새로운 잎
...
- ID: `reward-971167cf4d74`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. {gold} 골드, 몸통 박치기, 붉은 해골, 악의
- 확인된 선택지:
  - {gold} 골드
  - 몸통 박치기
  - 붉은 해골
...
- ID: `reward-c84792160397`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. {gold} 골드, 거상, 약화 포션, 자수정 가지
- 확인된 선택지:
  - {gold} 골드
  - 거상
  - 약화 포션
...
- ID: `reward-daa5cabf5ee8`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. {gold} 골드, 광란, 명확성 추출물, 석재 달력
- 확인된 선택지:
  - {gold} 골드
  - 광란
  - 명확성 추출물
...
- ID: `reward-ddd06ea43257`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 5턴 종료, 넘기기, 불타는 혈액, 새로운 잎
- 확인된 선택지:
  - 5턴 종료
  - 넘기기
  - 불타는 혈액
...
- ID: `reward-1f9f85c7bb71`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 거상, 약화 포션, 자수정 가지, 짓밟기
- 확인된 선택지:
  - 거상
  - 약화 포션
  - 자수정 가지
...
- ID: `reward-2bf1222f880a`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. NCardRewardSelectionScreen, 넘기기, 몸통 박치기, 악의
- 확인된 선택지:
  - NCardRewardSelectionScreen
  - 넘기기
  - 몸통 박치기
...
- ID: `reward-3cdd2de43c08`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. NCardRewardSelectionScreen, 넘기기, 사혈, 진정한 끈기
- 확인된 선택지:
  - NCardRewardSelectionScreen
  - 넘기기
  - 사혈
...
- ID: `reward-457552f49c93`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. NCardRewardSelectionScreen, 광란, 넘기기, 저글링
- 확인된 선택지:
  - NCardRewardSelectionScreen
  - 광란
  - 넘기기
...
- ID: `reward-5e209c1c8478`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 몸통 박치기, 붉은 해골, 악의, 약화 포션
- 확인된 선택지:
  - 몸통 박치기
  - 붉은 해골
  - 악의
...
- ID: `reward-6b5a745e6410`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. NCardRewardSelectionScreen, 그래플링, 넘기기, 잊힌 의식
- 확인된 선택지:
  - NCardRewardSelectionScreen
  - 그래플링
  - 넘기기
...
- ID: `reward-745889fe6f04`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. NCardRewardSelectionScreen, 거상, 넘기기, 짓밟기
- 확인된 선택지:
  - NCardRewardSelectionScreen
  - 거상
  - 넘기기
...
- ID: `reward-8282082a79bf`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. {gold} 골드, 민첩 포션, 완벽한 타격, 전투장비
- 확인된 선택지:
  - {gold} 골드
  - 민첩 포션
  - 완벽한 타격
...
- ID: `reward-bc2a4277a9fc`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. NCardRewardSelectionScreen, 넘기기, 완벽한 타격, 전투장비
- 확인된 선택지:
  - NCardRewardSelectionScreen
  - 넘기기
  - 완벽한 타격
...
- ID: `reward-eb499ed5cb3b`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. NCardRewardSelectionScreen, 거상, 약화 포션, 짓밟기
- 확인된 선택지:
  - NCardRewardSelectionScreen
  - 거상
  - 약화 포션
...
- ID: `reward-35a08a591685`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 광란, 석재 달력, 저글링, 전투장비
- 확인된 선택지:
  - 광란
  - 석재 달력
  - 저글링
...
- ID: `reward-3e59d630e2ff`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 넘기기, 완벽한 타격, 전투장비, 철의 파동
- 확인된 선택지:
  - 넘기기
  - 완벽한 타격
  - 전투장비
...
- ID: `reward-59b533cd3696`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 거상, 약화 포션, 짓밟기, 파열
- 확인된 선택지:
  - 거상
  - 약화 포션
  - 짓밟기
...
- ID: `reward-6269821d58cd`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 광란, 넘기기, 저글링, 전투장비
- 확인된 선택지:
  - 광란
  - 넘기기
  - 저글링
...
- ID: `reward-70242c3f1906`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. {gold} 골드, 사혈, 진정한 끈기, 천둥
- 확인된 선택지:
  - {gold} 골드
  - 사혈
  - 진정한 끈기
...
- ID: `reward-86929a5b9cd4`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 몸통 박치기, 붉은 해골, 악의, 완벽한 타격
- 확인된 선택지:
  - 몸통 박치기
  - 붉은 해골
  - 악의
...
- ID: `reward-e2998c9a136c`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. {gold} 골드, 그래플링, 잊힌 의식, 철의 파동
- 확인된 선택지:
  - {gold} 골드
  - 그래플링
  - 잊힌 의식
...
- ID: `reward-4ef0cb1e2b32`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 사혈, 진정한 끈기, 천둥
- 확인된 선택지:
  - 사혈
  - 진정한 끈기
  - 천둥
...
- ID: `reward-59db33bcd715`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 몸통 박치기, 악의, 완벽한 타격
- 확인된 선택지:
  - 몸통 박치기
  - 악의
  - 완벽한 타격
...
- ID: `reward-9fb2a2460eb1`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 그래플링, 잊힌 의식, 철의 파동
- 확인된 선택지:
  - 그래플링
  - 잊힌 의식
  - 철의 파동
...
- ID: `reward-b931031f8f53`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 그래플링, 넘기기, 잊힌 의식
- 확인된 선택지:
  - 그래플링
  - 넘기기
  - 잊힌 의식
...
- ID: `reward-d2b63ba97202`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 넘기기, 사혈, 천둥
- 확인된 선택지:
  - 넘기기
  - 사혈
  - 천둥
...
- ID: `reward-44cf523563a6`
- 그룹/풀 추정: 보상/UI, 선택지 확인됨
- 플레이 중 참조 시점: 보상 화면에서 보상 종류와 선택 구조 비교 시 참조
- 설명 상태: 선택지 또는 페이지 단위 정보까지는 연결되었지만, 전체 설명 완성도는 더 다듬어야 합니다.
- 핵심 설명: 선택지 정보는 확인되었지만 상세 설명 본문은 아직 비어 있습니다. 약화 포션
- 확인된 선택지:
  - 약화 포션
- 관찰 로그 반영: 예
- 주요 소스: `live-event:choice-list-presented`
